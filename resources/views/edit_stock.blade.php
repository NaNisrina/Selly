                                            ...
                                            <div class="form-items">
                                                ...
                                                <form action="{{ route('stock.update', $stock->id) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-12" style="width: 22rem;">
                                                        <img class="img-preview img-fluid mb-3 col-sm-5" src="{{ asset('storage/' . $stock->product_img) }}">
                                                    ...
                                                    <div class="col-md-12" style="width: 22rem;">
                                                        ...
                                                        <input class="form-control @error('product_name') is-invalid @enderror" id="product_name" type="text" name="product_name"
                                                            placeholder="Name" required value="{{ $stock->product_name }}">
                                                            @error('product_name')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-outline mt-3" style="width: 22rem;">
                                                        ...
                                                        <input type="number" id="quantity" name="quantity" class="form-control @error('quantity') is-invalid @enderror"
                                                            placeholder="Quantity" required value="{{ $stock->quantity }}">
                                                            @error('quantity')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-outline mt-3" style="width: 22rem;">
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="text" name="price" class="form-control @error('price') is-invalid @enderror"
                                                                id="price" placeholder="Price" value="{{ $stock->price }}">
                                                                @error('price')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
